...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 ${modalZIndex}`}
      ...
      >
        ...
        {/* Content */}
        <div className="p-6">
          <p id="confirm-dialog-description" className="text-slate-700">
            {description}
          </p>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-200">
          ...
          <button
            ...
            disabled={isLoading}
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${styles.button}`}
          >
            {isLoading && (
              <svg
