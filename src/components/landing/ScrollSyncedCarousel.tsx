  ...
  return (
    <>
      <style>{`
        ...
        .sticky-container { position: sticky; top: 10vh; height: 80vh; max-height: 700px; width: 100%; display: flex; align-items: stretch; background: #ffffff; border-radius: 24px; box-shadow: 15px 15px 30px #8fa7e9, -15px -15px 30px #eaeefa; overflow: hidden; }
